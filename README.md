...
4. **Variabile d'ambiente** (opzionale, per dati live torneo):
   - `VITE_SHEET_ID` = ID del tuo Google Sheet
...
4. Imposta la variabile d'ambiente:
   ...
   - **Vercel:** Project Settings → Environment Variables → `VITE_SHEET_ID`

Senza `VITE_SHEET_ID` il sito usa i dati demo del calendario dalla locandina.
