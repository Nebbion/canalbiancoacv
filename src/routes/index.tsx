...
const news = [
  {
    titolo: "Al via il 22° Torneo Trevisan Denis",
    data: "18 maggio 2026",
    excerpt: "Tre categorie e venti sere di calcio a Villamarzana.",
  },
  {
    titolo: "Memorial Luca Coltro 2026",
    data: "30 maggio 2026",
    excerpt: "Sabato 30 maggio l'edizione 2026 ad Arquà Polesine.",
  },
  {
    titolo: "Torneo Avis-Aido di Villamarzana",
    data: "23 maggio 2026",
    excerpt: "Piccoli Amici e Primi Calci in campo per la solidarietà.",
  },
];
  ...
  head: () => ({
    meta: [
      { title: "ASD Canalbianco ACV — Sito ufficiale" },
      {
        name: "description",
        content:
          "Società calcistica del Polesine. Settore giovanile, prima squadra e archivio del 22° Torneo Trevisan Denis 2026.",
      },
      { property: "og:title", content: "ASD Canalbianco ACV — Sito ufficiale" },
      {
        property: "og:description",
        content:
          "Settore giovanile, prima squadra e archivio Trevisan Denis 2026.",
      },
    ],
  }),
  component: Index,
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-8 py-20 grid gap-10 md:grid-cols-[1.4fr_1fr] items-center w-full">
          <div>
            ...
            <h1 className="mt-6 font-display text-5xl md:text-7xl lg:text-8xl leading-[0.95] tracking-wide">
              <span className="text-white">ASD CANALBIANCO</span>
              <br />
              <span className="text-primary text-glow">A.C.V.</span>
            </h1>
            <p className="mt-6 max-w-xl text-lg text-white/80 leading-relaxed">
              Passione, fair play, amicizia. Dal 2013 cresciamo insieme ai
              ragazzi del Polesine — sul campo e fuori.
            </p>
            <div className="mt-8 flex flex-wrap gap-3">
              <Link
                to="/archivio/tornei/trevisan-26"
                className="inline-flex items-center gap-2 rounded-md bg-primary px-6 py-3 text-sm font-bold uppercase tracking-wider text-primary-foreground shadow-glow hover:brightness-110"
              >
                Archivio Torneo 2026 <ArrowRight size={18} />
              </Link>
              <Link
                to="/squadre"
                className="inline-flex items-center gap-2 rounded-md border border-white/30 bg-white/5 backdrop-blur px-6 py-3 text-sm font-bold uppercase tracking-wider text-white hover:bg-white/15"
              >
                Le Squadre
              </Link>
              <Link
                to="/contatti"
                className="inline-flex items-center gap-2 rounded-md border border-white/20 px-6 py-3 text-sm font-bold uppercase tracking-wider text-white/80 hover:text-white hover:border-white/40"
              >
                Contatti
              </Link>
            </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-8 grid gap-10 md:grid-cols-[1fr_auto] items-center">
          <div>
            ...
            <h2 className="mt-2 font-display text-4xl md:text-6xl tracking-wide">
              22° Torneo{" "}
              <span className="text-primary text-glow">"Trevisan Denis"</span>
            </h2>
            <p className="mt-4 text-white/80 text-lg max-w-2xl">
              Dal <strong>18 maggio</strong> al <strong>6 giugno 2026</strong> ·
              Campo Sportivo di Villamarzana
              <br />3 categorie · Pulcini ore 19 · Esordienti ore 20 ·
              Giovanissimi ore 21
            </p>
            <div className="mt-6 flex flex-wrap gap-3">
              ...
              >
                Vai all'archivio <ArrowRight size={16} />
              </Link>
              <Link
                to="/archivio/tornei/trevisan-26"
                className="rounded-md border border-white/30 px-5 py-3 text-sm font-bold uppercase tracking-wider hover:bg-white/10"
              >
                Risultati
              </Link>
              <Link
          ...
          <div className="hidden md:flex flex-col gap-3">
            {[
              ...
              <div
                key={b.label}
                className="flex items-center gap-3 rounded-lg border border-white/15 bg-white/5 backdrop-blur px-5 py-3"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 grid gap-10 md:grid-cols-3">
          <div className="md:col-span-2">
            <div className="flex items-center gap-2 text-primary font-bold uppercase tracking-widest text-sm">
              <Newspaper size={16} /> News società
            </div>
            <h2 className="font-display text-4xl tracking-wide mt-2 mb-6">
              Ultime dal club
            </h2>
            <ul className="space-y-4">
              {news.map((n) => (
                <li
                  key={n.titolo}
                  className="rounded-xl bg-card p-5 border-l-4 border-primary hover:shadow-stadium transition"
                >
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-2">
              {[1, 2, 3, 4].map((i) => (
                <div
                  key={i}
                  className="aspect-square rounded-lg bg-secondary relative overflow-hidden"
                >
            ...
            <Link
              to="/gallery"
              className="mt-4 inline-flex items-center gap-2 text-sm font-semibold uppercase tracking-wider text-primary hover:underline"
            >
